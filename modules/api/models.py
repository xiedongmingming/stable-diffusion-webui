...
class EmbeddingsResponse(BaseModel):
    ...
    skipped: Dict[str, EmbeddingItem] = Field(title="Skipped",
...
class ScriptArg(BaseModel):
    ...
    minimum: Optional[Any] = Field(default=None, title="Minimum",
                                   description="Minimum allowed value for the argumentin UI")
    maximum: Optional[Any] = Field(default=None, title="Minimum",
